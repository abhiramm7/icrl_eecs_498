...
q_nn = build_network(4, 6, 2, 32, "relu", 0.0);
...
for weights in np.linspace(0, 7000, 71, dtype=int):
...
np.save("sum_rewards_adqn_with_out_target", model_reward)
np.save("action_space_adqn_with_out_target", time_act)
